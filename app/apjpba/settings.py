# Django settings for apjpba project.
...
FILES_URL = '/path/to/files'
STATIC_DOC_ROOT = '/path/to/www'
...
SESSION_COOKIE_NAME = 'sessionfiles'
...
AUTHENTICATION_BACKENDS = (
    'apjpba.users.backends.EmailOrUsernameModelBackend',
